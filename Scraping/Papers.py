...
config = {
    ...
    "pagination" : Paginate("https://www.dhyeyaias.com/papers"),
...
curser.execute("select * from categories where `category_slug` = 'papers';")
primary_category_id = curser.fetchall()[0][0]
sub_category_id = save_category(curser,primary_category_id,"papers",2)
connector.commit()
