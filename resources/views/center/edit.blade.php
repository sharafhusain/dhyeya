...
@section('content')
    <div class="container">
        <div class="card my-4">
            ...
            <div class="card-body">
                <form action="{{route('edit-center', $center->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <img style="height: 150px;" class="cus-img-op m-2 img-thumbnail"
                                     src="{{asset('storage/media/'.$center->image)}}">
                                <input class="form-control cus-img" type="file" id="image" name="image"
                                       value="{{old('image', $center->image)}}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="center_type" name="center_type">
                                    ...
                                    <option
                                        value="Face To Face" @selected(old('center_type', $center->center_type) == 'Face To Face')>
                                        Face To Face
                                    </option>
                                    <option
                                        value="Live Stream" @selected(old('center_type', $center->center_type) == 'Live Stream')>
                                        Live Stream
                                    </option>
                                </select>
                            </div>
