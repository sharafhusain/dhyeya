    ...
    <div class="container">
        <div class="card my-4">
            <div class="card-header">
                <h5 class="card-title">Create New Courses</h5>
            </div>
            <div class="card-body">
                <form action="{{route('create-courses')}}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control mySecondaryEditor" type="text" id="en.course_information"
                                          ...
                                          rows="3">{{old('en.course_information')}}</textarea>
                            </div>
                            <div class="mb-3">
                                ...
                                <textarea class="form-control mySecondaryEditor" type="text" id="en.admission_process"
                                          ...
                                          rows="3">{{old('en.admission_process')}}</textarea>
                            </div>
                            <div class="mb-3">
                                ...
                                <textarea class="form-control mySecondaryEditor" type="text"
                                          ...
                                          rows="3">{{old('en.technical_requirement')}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control mySecondaryEditor" type="text" id="hi.course_information"
                                          ...
                                          rows="3">{{old('hi.course_information')}}</textarea>
                            </div>
                            <div class="mb-3">
                                ...
                                <textarea class="form-control mySecondaryEditor" type="text" id="hi.admission_process"
                                          ...
                                          rows="3">{{old('hi.admission_process')}}</textarea>
                            </div>
                            <div class="mb-3">
                                ...
                                <textarea class="form-control mySecondaryEditor" type="text"
                                          ...
                                          rows="3">{{old('hi.technical_requirement')}}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="mode" name="mode">
                                    ...
                                    <option value="Online & Offline" @selected(old('mode') == 'Online & Offline')>Online & Offline</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="course_type" name="course_type">
                                    ...
                                    <option
                                        value="General Online" @selected(old('course_type') == 'General Online')>
                                        General Online Course
                                    </option>
                                    <option value="Optional Online" @selected(old('course_type') == 'Optional Online')>
                                        Optional Online Course
                                    </option>
                                    <option value="General Pen Drive" @selected(old('course_type') == 'General Pen Drive')>
                                        General Pen Drive Course
                                    </option>
                                    <option value="Optional Pen Drive" @selected(old('course_type') == 'Optional Pen Drive')>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="number" id="installment_duration"
                                           name="installment_duration" value="{{old('installment_duration')}}">
