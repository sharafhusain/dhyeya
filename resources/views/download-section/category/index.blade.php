@php($title = 'Download Category Pages')
@extends('layouts.dashboard')
@section('content')
    <div class="card">
        <div class="card-header d-flex gap-3">
            <h5>Download Category Pages</h5>
            ...
            <table
                ...
                @foreach($categories as $category)
                    <tr>
                        ...
                        <td>
                            @if($level <= 2)
                                <a href="{{route('download-category',[$level,$category?->id])}}" class="btn btn-dark btn-sm"
...
@section('script')
    <script>
        $(document).ready(function () {
            ...
            const creatURL = '{{route('download-create-category',[$level-1,$categoryP])}}';
            ...
            const updateURL = '{{route('download-edit-category',[$level-1,":cat_id"])}}';
