        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="d-flex mb-3">
                    <div class="w-100">
                        <input id="autoComplete" class="w-100 mb-2 rounded-0" type="search" dir="ltr" spellcheck=false
                               autocorrect="off" autocomplete="off" autocapitalize="off" maxlength="2048" tabindex="1">
                    </div>
                    <div style="width:15%">
                        <select class="form-select rounded-0 border-start-0 shadow-none"
                                style="border-color: #FF7A7A7F;height:3rem;">
                            <option value="All">All</option>
                            <option value="Course" class="d-none">Course</option>
        ...
        $(document).ready(function () {
            ...
            $('.menu-list').on('change', function () {
                ...
                if ($(this).prop('checked')) {
                    ...
                    const menu_item = $('ul.menu-container webli[data-menu-id=' + $(this).val() + ']');
            ...
            function addMenuItem(id, title, type) {
                $('ul.menu-container').append('<li class="list-group-item" data-menu-id="' + id + '">' + title + '' +
                    '<input type="hidden" name="menu_items[]" value ="' + id + '"/>  <span class="badge text-bg-success">' + type + '</span>' +
                    '<input type="button" onclick="remove()" class="btn btn-sm btn-danger float-end" value ="Remove" data-type="' + type + '" data-id="' + id + '"> </li>');
            }//Todo: Solve checkbox issue here
